...
let DataStoreService = class DataStoreService {
    ...
    async upsertRows(dataStoreId, projectId, dto, returnData = false) {
        await this.validateDataStoreExists(dataStoreId, projectId);
        ...
        const columns = await this.dataStoreColumnRepository.getColumns(dataStoreId);
        return await this.dataStoreRowsRepository.upsertRows(dataStoreId, matchFields, rows, columns, returnData);
    }
    async updateRow(dataStoreId, projectId, dto, returnData = false) {
        await this.validateDataStoreExists(dataStoreId, projectId);
        const columns = await this.dataStoreColumnRepository.getColumns(dataStoreId);
        if (columns.length === 0) {
        ...
        return await this.dataStoreRowsRepository.updateRow(dataStoreId, data, filter, columns, returnData);
    }
    ...
    validateAndTransformFilters(dto) {
