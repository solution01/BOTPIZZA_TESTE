...
export declare class DataStoreController {
    ...
    upsertDataStoreRows(req: AuthenticatedRequest<{
        projectId: string;
    }>, _res: Response, dataStoreId: string, dto: UpsertDataStoreRowsDto): Promise<true | DataStoreRowReturn[]>;
    updateDataStoreRow(req: AuthenticatedRequest<{
        projectId: string;
    }>, _res: Response, dataStoreId: string, dto: UpdateDataStoreRowDto): Promise<true | DataStoreRowReturn[]>;
