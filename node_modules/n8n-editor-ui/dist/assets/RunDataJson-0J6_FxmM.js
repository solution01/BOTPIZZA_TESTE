const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-ZbUSwg32.js","assets/index--OJ5nhDf.js","assets/index-DXNU_2Fk.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-B2jW3_UG.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, aY as useNDVStore, cK as useTelemetryContext, r as ref, gi as useElementSize, x as computed, hc as executionDataToJson, h as createElementBlock, g as openBlock, e as createBlock, i as createVNode, w as withCtx, f as createCommentVNode, l as unref, ds as defineAsyncComponent, dr as Suspense, hd as VueJsonPretty, h7 as __unplugin_components_0, n as normalizeClass, h8 as MappingPill, ge as Draggable, aU as __vitePreload, h9 as shorten, hb as getMappedExpression, bp as useExternalHooks, al as useTelemetry, he as isString, hf as nonExistingJsonPath, _ as _export_sfc } from "./index--OJ5nhDf.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-ZbUSwg32.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
