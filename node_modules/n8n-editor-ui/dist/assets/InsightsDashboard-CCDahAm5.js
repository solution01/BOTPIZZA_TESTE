const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-Cp82bMTp.js","assets/index--OJ5nhDf.js","assets/index-DXNU_2Fk.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-T1SFp7S-.js","assets/chartjs.utils-DIRvJRrn.js","assets/InsightsSummary-I5vKNG0I.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-D2apwRup.js","assets/InsightsChartFailed-Dn6SuM16.js","assets/InsightsChartFailureRate-CJl1j0ob.js","assets/InsightsChartTimeSaved-B5DjojXI.js","assets/InsightsChartAverageRuntime-CoBgniUR.js","assets/InsightsTableWorkflows-D1U89HJ4.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, eg as useModel, gb as useInsightsStore, r as ref, gY as UNLICENSED_TIME_RANGE, gl as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, l as unref, e9 as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, e8 as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, gZ as ElDialog, aA as usePageRedirectionHelper, _ as _export_sfc, a2 as useRoute, g_ as INSIGHT_TYPES, ds as defineAsyncComponent, a7 as watch, o as onMounted, ax as useDocumentTitle, m as N8nHeading, n as normalizeClass, dJ as _sfc_main$4, c4 as resolveDynamicComponent, aU as __vitePreload, al as useTelemetry, g$ as TELEMETRY_TIME_RANGE } from "./index--OJ5nhDf.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-Cp82bMTp.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-T1SFp7S-.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-Dn6SuM16.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-CJl1j0ob.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-B5DjojXI.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-CoBgniUR.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-D1U89HJ4.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
