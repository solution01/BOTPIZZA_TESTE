export declare const MAX_AI_BUILDER_PROMPT_LENGTH = 1000;
...
export declare const DEFAULT_AUTO_COMPACT_THRESHOLD_TOKENS = 20000;
export declare const MAX_WORKFLOW_LENGTH_TOKENS = 30000;
export declare const AVG_CHARS_PER_TOKEN_ANTHROPIC = 2.5;
export declare const PLAN_APPROVAL_MESSAGE = "Proceed with the plan";
